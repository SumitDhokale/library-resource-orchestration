...
//             if (!userError && userData) {
//               setCurrentUser({ email: session.user.email, role: userData.role });
//             }
//           });
//       } else {
//         setCurrentUser(null);
...
//       }
//     } else {
//       // ✅ Registration logic with fixed role = 'user'
//       if (!name.trim()) {
//         setError('Please enter your name');
//         setLoading(false);
//         return;
...
//       // Insert into users table with fixed role
